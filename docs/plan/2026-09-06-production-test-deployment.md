...
- [x] B6. Владелец определил тест без доменов/TLS: API `http://94.250.251.94:3180/`, frontend `http://94.250.251.94:3181`, admin `http://94.250.251.94:3195`. Команды настройки сохранены в [инструкции](../test-deployment-commands.md); применение на VPS отдельно.
