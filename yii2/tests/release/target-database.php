...
$tables=[
    ...
    'game_five'=>['id'=>'pk','user_id'=>'integer','user_gamer'=>'integer','kon'=>'decimal(18,5)','status'=>'char(50)','user_amount'=>'integer','gamer_amount'=>'integer','created_at'=>'integer','updated_at'=>'integer'],
    'game_five_hod'=>['id'=>'pk','game_five_id'=>'integer','user_id'=>'integer','user_gamer'=>'integer','user_ball'=>'integer','gamer_ball'=>'integer','status'=>'char(50)','user_amount'=>'integer','gamer_amount'=>'integer','created_at'=>'integer'],
